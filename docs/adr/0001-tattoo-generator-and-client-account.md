...
| Устройство сервера | Уровни 4–5 по ADR-0009: языки, библиотеки, база, очередь, фоновые задания, запуск, инфраструктура и выпуск. Уточнение 2026-09-14: база — ADR-0013, очередь и фоновые задания — ADR-0014, языки и библиотеки — документ стека; открыты запуск, инфраструктура и выпуск | Выполнение и обслуживание приложения |
